...
# print(unique_element[1]) set does not have index numbers

print(unique_element.remove(10))

print(unique_element.update({1, 2, 3, 4, 5}))  # to set new elements and clean the older one

unique_element.pop()

print(unique_element)  # one element will be removed

print(help(set.pop))

print(help(str))  # to get the information using help method
